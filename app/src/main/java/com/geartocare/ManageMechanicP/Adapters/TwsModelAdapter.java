...
public class TwsModelAdapter extends RecyclerView.Adapter<TwsModelAdapter.MyViewHolder>{
    ArrayList<String> mlist;
    Context context;

    public TwsModelAdapter(ArrayList<String> mlist, Context context) {
        this.mlist = mlist;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new TwsModelAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.card_company,parent,false));
    }
