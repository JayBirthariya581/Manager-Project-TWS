...
public class BookingsSlotAdapter extends RecyclerView.Adapter<BookingsSlotAdapter.MyViewHolder> {
    ...
    public BookingsSlotAdapter(ArrayList<String> mlist, Context context) {
        this.mlist = mlist;
    ...
    public void setBookingsDate(String bookingsDate) {
        BookingsDate = bookingsDate;
    }

    @NonNull
    @Override
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new BookingsSlotAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.card_general_date,parent,false));
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(context, BookingServicesActivity.class);
                i.putExtra("date",BookingsDate);
            ...
            public boolean onLongClick(View view) {
                ...
                db.delete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        dialog.dismiss();
                        progressDialog.show();
                        FirebaseDatabase.getInstance().getReference("AppManager").child("SlotManager").child("offDays").child(time)
