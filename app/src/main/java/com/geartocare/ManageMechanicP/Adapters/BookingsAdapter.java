...
import com.geartocare.ManageMechanicP.Activities.BookingsSlotListActivity;
...
public class BookingsAdapter extends RecyclerView.Adapter<BookingsAdapter.MyViewHolder> {
    ...
    public BookingsAdapter(ArrayList<String> mlist, Context context) {
        this.mlist = mlist;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new BookingsAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.card_general_date, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(context, BookingsSlotListActivity.class);
